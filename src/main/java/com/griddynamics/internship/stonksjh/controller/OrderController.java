...
public class OrderController {
    ...
    public ResponseEntity<?> create(@RequestBody OrderRequestDTO orderRequestDTO, @RequestParam UUID userUuid) {
        val orderDTO = crudService.create(orderRequestDTO, userUuid);
